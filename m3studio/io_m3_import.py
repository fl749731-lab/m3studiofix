    ...
    def create_turrets(self):
        ...
        for m3_turret in self.m3[self.m3_model.turrets]:
            ...
            for ii in self.m3[m3_turret.parts]:
                ...
                if m3_part.desc.version >= 4:
                    part['quat_up0'] = tuple(to_bl_vec4(m3_part.quat_up0))
                    part['quat_up1'] = tuple(to_bl_vec4(m3_part.quat_up1))
                    part['main_bone_offset'] = tuple(to_bl_vec3(m3_part.main_bone_offset))
